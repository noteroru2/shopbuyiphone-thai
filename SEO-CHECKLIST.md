# SEO / AEO / GEO Checklist — ร้านรับซื้อไอโฟน.com
...
- [ ] Hero LCP: มี WebP คู่ PNG (ถ้าใช้ `<picture>`) และ `width`/`height` ตรง intrinsic
...
- [ ] มี “answer blocks” (คำตอบสั้น/ขั้นตอน/เช็กลิสต์/FAQ) ในหน้าหลักและบทความ — หน้าแรกมีการ์ด AEO + FAQ แยกชุด + GEO block

## AEO / GEO
- [ ] `public/llms.txt` มี facts + หน้าสำคัญ + วิธีประเมินราคา
- [ ] มี hub pages: `/รับซื้อไอโฟน/`, `/คำถามที่พบบ่อย/`, `/พื้นที่ให้บริการ/`, `/blog/`
