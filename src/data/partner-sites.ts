...
export interface PartnerSite {
  ...
  /** ลำดับแนะนำสำหรับ anchor text — ห้ามใช้ anchor หลักของเว็บนี้ไปชี้เว็บอื่นแบบทำให้เข้าใจผิด */
...
export const partnerSites: PartnerSite[] = [
  ...
  },
  {
    ...
    description:
      'เว็บไซต์รับซื้อสินค้าไอทีหลายประเภท เช่น คอมพิวเตอร์พกพา แท็บเล็ต iPhone iPad และอุปกรณ์มือสอง',
  ...
  },
  {
    ...
    description: 'บริการรับซื้อคอมพิวเตอร์พกพาและอุปกรณ์ IT มือสอง',
    category: 'it-specialist',
    recommendedAnchors: ['Winner IT', 'บริการรับซื้อคอมและอุปกรณ์ IT', 'เว็บรับซื้ออุปกรณ์ IT'],
  },
  {
    id: 'shop-laptop-punycode',
    brand: 'ร้านรับซื้อคอมพิวเตอร์พกพา (เว็บเครือ)',
    url: 'https://www.xn--42cn4aobed0eb6hubj4es0m5dhvd.com/',
    description:
      'บริการรับซื้อคอมพิวเตอร์พกพามือสอง ประเมินราคาผ่าน LINE @webuy — ช่องทางเดียวกับร้านรับซื้อไอโฟน.com',
    category: 'it-specialist',
    recommendedAnchors: [
      'ดูเว็บรับซื้อคอมพิวเตอร์พกพา',
      'เว็บในเครือ — คอมพิวเตอร์พกพา',
      'ประเมินราคามือสอง (เครือ)',
    ],
  },
  {
    id: 'rubsoo-camera',
...
export const partnerFooterIds = [
  'amphon-trading',
  'wortrub',
  'webuy-hub',
  'rubsoo-camera',
  'shop-laptop-punycode',
] as const;
