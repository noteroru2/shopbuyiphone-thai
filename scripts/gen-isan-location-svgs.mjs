...
function phoneGraphic() {
  ...
  <g opacity="0.92" aria-hidden="true">
    <rect x="860" y="160" width="200" height="360" rx="28" fill="rgba(255,255,255,0.07)" stroke="rgba(255,255,255,0.28)" stroke-width="2"/>
    <rect x="880" y="190" width="160" height="280" rx="6" fill="rgba(255,255,255,0.1)"/>
    <circle cx="960" cy="490" r="14" fill="rgba(255,255,255,0.18)"/>
  </g>`;
}
...
function provinceSvg(title, fileBase) {
  ...
  const line1 = `รับซื้อไอโฟน${title}`;
  const line2 = 'ส่งรูปประเมินก่อนนัด · ไลน์ @webuy · โทร 0642579353';
  const line3 = 'ร้านรับซื้อไอโฟน.com · ภาคอีสาน';
...
function hubSvg() {
  ...
  const line1 = 'รับซื้อไอโฟนภาคอีสาน';
  const line2 = '20 จังหวัด · ส่งรูปประเมินก่อนนัด · ไลน์ @webuy · โทร 0642579353';
  const line3 = 'ร้านรับซื้อไอโฟน.com';
  return `<?xml version="1.0" encoding="UTF-8"?>
<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="630" viewBox="0 0 1200 630" role="img" aria-label="${escapeXml(line1)}">
  <defs>
    <linearGradient id="${gid}" x1="0%" y1="0%" x2="100%" y2="100%">
